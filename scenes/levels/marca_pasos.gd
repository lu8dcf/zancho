...
func multiplicador(multi):
	...
	GlobalJuego.tiempo_ataque=GlobalJuego.tiempo_ataque_ref/multi
	GlobalJuego.tiempo_pasos=GlobalJuego.tiempo_pasos_ref/multi
	wait_time = GlobalJuego.tiempo_pasos
